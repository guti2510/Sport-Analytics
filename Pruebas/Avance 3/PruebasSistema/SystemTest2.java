...
public class SystemTest2 {
  ...
  @Test
  public void testAnalisisVideo() throws Exception {
    driver.get(baseUrl);
    driver.findElement(By.name("upload")).clear();
    Thread.sleep(2000);
    driver.findElement(By.name("upload")).sendKeys("F:\\Cursos\\II Semestre 2016\\Aseguramiento de software\\Proyectos\\Proyecto_Web\\Sport-Analytics\\Video.mp4");
    Thread.sleep(2000);
